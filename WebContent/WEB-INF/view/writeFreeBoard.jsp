...
<head>
    <meta charset="UTF-8">
    <title>글작성 - 자유게시판 | Gift Guide Book</title>
...
<form id="writeForm" action="/viewArticle" method="POST">
...
<button id="prevCommunityBtn" type="button" onclick="location='/freeBoard'" class="writeBoard_wrap_btn"><i class="fas fa-reply"></i> 목록으로</button>
</div>
</form>
