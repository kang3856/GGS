...
<head>
    <meta charset="UTF-8">
    <title>나도 산타다 | GiftGuideService</title>
...
<div id="communityBoardDetailWrap">
    ...
    <div id="communityBoardReply">
        ...
        <a class="prev_btn" href="/giveBoard">이전으로</a>
        <div id="replyBox">
            <span>댓글 </span>
...
$(".like_btn").click(function() {
	...
	<c:otherwise>
		...
		$.ajax({
			...
			dataType:"json",
			type:"POST",
			data:{postNum:${no},type:"S", memberNo:${loginMember.no}},
			error:function() {
				alert("서버 점검중!");
			},
...
viewer: true,
    width : 900,
height: 600,
initialValue:`<img src="/img/giveRule.png">
${article.content }
`
});
var $window = $(window);
